...
<html>
    <head>
        ...
        <jsp:useBean id="l" class="dao.ExamDAO" scope="request"></jsp:useBean>
        <!-- Favicon -->
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <a href="#" class="nav-item nav-link">Collections</a>
                        ...
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-sm-10 col-lg-8">
                                    ...
                                    <p class="fs-5 text-white mb-4 pb-2">With Flearn, you can embark on an exciting educational journey where knowledge meets convenience.</p>
                        ...
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-sm-10 col-lg-8">
                                    ...
                                    <p class="fs-5 text-white mb-4 pb-2">Our platform offers a diverse range of courses taught by expert instructors, allowing you to acquire new skills, deepen your understanding, and unlock your full potential.</p>
                                    <a href="" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Read More</a>
                                    <a href="" class="btn btn-light py-md-3 px-md-5 animated slideInRight">Join Now</a>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="course-item bg-light">
                            <div class="position-relative overflow-hidden">
                                ...
                                <div class="w-100 d-flex justify-content-center position-absolute bottom-0 start-0 mb-4">
                                    <a href="#" class="flex-shrink-0 btn btn-sm btn-primary px-3" style="border-radius: 50px ;">Join Now</a>
                                </div>
                            </div>
                            <div class="text-center p-4 pb-0">
                ...
                <div class="owl-carousel testimonial-carousel position-relative">
                    <div class="testimonial-item text-center">
                        ...
                        <div class="testimonial-text bg-light text-center p-4">
                            <p class="mb-0">Flearn is fantastic! The courses are informative and well-organized.</p>
                        </div>
                    </div>
                    <div class="testimonial-item text-center">
                        ...
                        <p>Profession</p>
                        <div class="testimonial-text bg-light text-center p-4">
                            <p class="mb-0">I love Flearn! It's made learning so convenient and enjoyable.</p>
                        </div>
                    </div>
                    <div class="testimonial-item text-center">
                        ...
                        <p>Profession</p>
                        <div class="testimonial-text bg-light text-center p-4">
                            <p class="mb-0">Highly recommend Flearn! The instructors are top-notch.</p>
                        </div>
                    </div>
                    <div class="testimonial-item text-center">
                        ...
                        <p>Profession</p>
                        <div class="testimonial-text bg-light text-center p-4">
                            <p class="mb-0">Flearn has exceeded my expectations. Great learning platform!</p>
                        </div>
                    </div>
                </div>
            </div>
